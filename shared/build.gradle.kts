...
/** The package of the shared code; the generated `Res` class and Markdown constants land in it. */
val appPackage = "com.example.template"
...
val markdown = tasks.register("generateMarkdown") {
    ...
    doLast {
        ...
        val file = output.get().file(packageName.replace('.', '/') + "/Markdown.kt").asFile
