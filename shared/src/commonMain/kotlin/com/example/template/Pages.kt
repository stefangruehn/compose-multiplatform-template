...
private val GROUPS: Map<Page, List<Pair<Page, StringResource>>> = mapOf(
    Page.Home to listOf(
        Page.Example to Res.string.page_example_detail,
    ),
...
/**
 * The content of [page]; [libraries] reads the list for [Page.Libraries],
...
fun PageContent(
    ...
    if (cards != null) {
        ...
        LibrariesContainer(
            ...
            // Shows the licence text built into the app instead of opening a web page.
...
internal fun textOf(page: Page): String = when (page) {
    ...
    Page.Home, Page.Example, Page.About, Page.Settings, Page.Libraries -> ""
}
